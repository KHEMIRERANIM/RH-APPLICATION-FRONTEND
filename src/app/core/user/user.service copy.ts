...
export class UserService
{
    ...
    /**
     * Get user points for formations
     *
     * @param employeId
     */
    getUserPoints(employeId: string): Observable<any> {
        return this._httpClient.get<any>(`http://localhost:8081/api/formations/points/${employeId}`);
    }
}