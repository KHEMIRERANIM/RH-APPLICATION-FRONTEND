...
import { user as userData, userEmploye, userCandidat } from 'app/mock-api/common/user/data';
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                if ( password !== 'admin' ) { return [404, false]; }

                let user;
                if ( email === 'jean.dupont@entreprise.com' ) { user = cloneDeep(userData); }
                else if ( email === 'marie.martin@entreprise.com' ) { user = cloneDeep(userEmploye); }
                else if ( email === 'pierre.bernard@email.com' ) { user = cloneDeep(userCandidat); }
                else { return [404, false]; }
