...
import { Category, Course, DemandeConge, DemandeCongeRequest, ValidationCongeRequest, SoldeConge, BulletinSalaire, BulletinSalaireRequest, User, AlerteTendance, AdminStats, PredictionResponse, RecommandationEmployeResponse, Role } from 'app/modules/admin/apps/academy/academy.types';
