...
import { OffreAvantage, CategorieOffreAvantage, Wishlist } from '../../models/partnerships.models';
...
export class MesFavorisComponent implements OnInit, OnDestroy {
    ...
    offresFavorites: OffreAvantage[] = [];
    
    isLoading = true;
    isRemoving: { [idOffreAvantage: string]: boolean } = {};
    ...
    retirerFavori(offre: OffreAvantage): void {
